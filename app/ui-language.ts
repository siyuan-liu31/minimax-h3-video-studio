...
const ENGLISH_COPY: Readonly<Record<string, string>> = {
  ...
  "模型已就绪": "Model ready",
  "服务端尚未提供歌曲参数能力，请更新后再提交。": "The server does not support song tuning yet. Update it before submitting.",
  "原音频": "Source Audio",
  ...
  "录完试听，选择用途后上传": "Preview, choose a destination, then upload",
  "这段录音用作": "Use this recording as",
  ...
  "歌曲换声参数": "Song Conversion Settings",
  "采样步数": "Diffusion Steps",
  "引导强度": "Guidance Scale",
  "随机种子": "Random Seed",
  "步": "steps",
  "引导": "Guidance",
  "种子": "Seed",
  "官方流程推荐 100 步作为质量与速度折中，并非所有歌曲的最优值。-1 表示每次随机；任务中会记录实际种子。改用记录的种子可复现抽卡条件，GPU 运行仍可能有微小差异。": "The upstream workflow uses 100 steps as a quality/speed balance, not a universal optimum. -1 picks a new seed per task; the effective seed is saved. Reuse it to repeat the settings, though GPU output can vary slightly.",
  "复用参数": "Reuse Settings",
  "输出与效果": "Outputs & Effects",
  "歌曲输出与效果": "Song Outputs & Effects",
  "保留换声干声与原伴奏，供试听和导出": "Keep dry converted vocals and accompaniment for preview and export",
  "最终混音加入回声": "Add echo to final mix",
  "最终混音加入混响": "Add reverb to final mix",
  "效果开关只作用于最终混音；干声与伴奏保持原样。旧任务仍可试听和下载原有成品。": "Effect switches only change the final mix; dry vocals and accompaniment stay unchanged. Existing tasks can still preview and download their original result.",
  "保留分轨": "Stems retained",
  "仅最终混音": "Final mix only",
  "回声": "Echo",
  "混响": "Reverb",
  "开": "On",
  "关": "Off",
  "试听与导出音轨": "Track to preview and export",
  "最终混音": "Final Mix",
  "换声干声": "Dry Converted Vocal",
  "原伴奏": "Original Accompaniment",
  "最终混音试听": "Preview final mix",
  "换声干声试听": "Preview dry converted vocal",
  "原伴奏试听": "Preview original accompaniment",
  "试听与导出使用同一份音轨文件。": "Preview and export use the same audio file.",
  "导出": "Export ",
