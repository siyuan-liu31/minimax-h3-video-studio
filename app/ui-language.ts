...
const ENGLISH_COPY: Readonly<Record<string, string>> = {
  ...
  "选择歌曲": "Choose a song",
  "自动识别原歌词": "Automatically transcribe lyrics",
  "原歌曲": "Original song",
  "识别并修改歌词": "Transcribe and edit lyrics",
  "原歌词": "Original lyrics",
  "原歌词 · 可校正": "Original lyrics \u00b7 correct if needed",
  "新歌词 · 在这里修改": "New lyrics \u00b7 edit here",
  "识别原歌词": "Transcribe lyrics",
  "重新识别原词": "Transcribe again",
  "正在识别…": "Transcribing\u2026",
  "草稿保存在此浏览器": "Draft saved in this browser",
  "将原词复制到新词": "Copy original lyrics",
  "高级设置 · 音色与生成参数": "Advanced \u00b7 voice and generation",
  "使用其他参考音色": "Use another reference voice",
  "试听与生成": "Preview and generate",
  "先试听第一段": "Preview the first segment",
  "生成完整改词歌曲": "Generate full rewritten song",
  "改词与试听记录": "Rewrite and preview history",
  "原歌词识别": "Lyric transcription",
  "查看识别歌词": "View transcribed lyrics",
  "原曲": "Original",
  "改后音频": "Processed audio",
  "生成混音": "Generated mix",
  "调整后的混音": "Adjusted mix",
  "同位置切到原曲": "Switch to original at this position",
  "同位置切到结果": "Switch to result at this position",
  "调整人声与伴奏": "Balance vocals and accompaniment",
  "人声": "Vocals",
  "伴奏": "Accompaniment",
  "突出伴奏": "Emphasize accompaniment",
  "应用并生成混音": "Apply and remix",
  "正在混音…": "Remixing\u2026",
  "原词自动填入右侧，直接修改想替换的句子。识别可能有误，可在左侧校正。": "Original lyrics appear on the right for editing. Correct transcription mistakes on the left.",
  "当前使用原唱音色，无需上传参考音频。": "Using the original singer; no reference upload needed.",
  "每行对应一句，字数越接近原词，节奏通常越自然。": "One phrase per line. Similar syllable counts usually sound more natural.",
  "保留原伴奏，输出三轨": "Preserve backing and save three tracks",
  "伴奏不明显时，降低人声或提高伴奏。只重新混音，无需重新生成。": "Lower vocals or raise accompaniment when it is hard to hear. Remixing does not regenerate the vocals.",
  "保留原始结果；音量过高时会整体衰减以避免削波。本次混音不添加回声或混响。": "Original results stay intact. Excessive levels are attenuated to avoid clipping. No echo or reverb is added.",
  ...
  "抖音链接或分享文本": "Douyin link or share text",
  "下载清晰度": "Download quality",
  "最佳可用画质": "Best available quality",
  "最高 1080p": "Up to 1080p",
  "最高 720p": "Up to 720p",
  "解析链接": "Parse link",
  "下载到资产库": "Download to library",
  "下载在 Studio 服务器执行。需要登录时，可在本机用 CLI 下载并上传。": "Downloads run on the Studio server. If login is required, use the local CLI to download and upload.",
  "本机登录态导入": "Import using a local browser session",
  "下载任务": "Download tasks",
  "暂无下载任务": "No download tasks yet",
  "用于复刻": "Use for replication",
  "下载文件": "Download file",
  "解析中": "Parsing",
  "下载中": "Downloading",
  "导入资产中": "Importing asset",
  "下载进度": "Download progress",

  "项目已在其他位置更新。请撤销未保存修改，读取最新内容后再编辑。": "This project changed elsewhere. Discard unsaved changes and review the latest version before editing.",
  "复刻项目": "Replication project",
  "新建复刻": "New replication",
  "导出项目 JSON": "Export project JSON",
  "素材与方案": "Source and plan",
  "分段审阅": "Review segments",
  "复刻工作步骤": "Replication workflow",
  "已保存的复刻方案": "Saved replication plan",
  "保存草稿并审阅分段": "Save draft and review segments",
  "导出方案 JSON": "Export plan JSON",
  "审阅分段": "Review segments",
  "项目已保存，可继续审阅分段或查看成片。": "Project saved. Continue reviewing segments or view the final video.",
  "镜头分析检测切点，不会自动理解剧情、对白或字幕。请在分段审阅中检查并调整每段提示词。": "Scene analysis detects cuts; it does not understand plot, dialogue or captions. Review and adjust each segment prompt.",
  "生成未完成分段": "Generate unfinished segments",
  "来源片段": "Source segment",
  "生成片段": "Generated segment",
  "分段提示词": "Segment prompt",
  "保存分段修改": "Save segment changes",
  "撤销未保存修改": "Discard unsaved changes",
  "生成 / 重跑此段": "Generate / rerun this segment",
  "此段尚无生成结果": "No generated output for this segment yet",
  "来源视频暂不可用": "Source video unavailable",
  "分段列表": "Segments",
  "CLI 与项目标识": "CLI and project IDs",
  "保存或重跑会使当前段和依赖它的连续片段需要重新生成。": "Saving or rerunning invalidates this segment and its dependent continuation segments.",
  "有未保存的分段修改，请先保存或撤销。": "Save or discard your segment changes before continuing.",
  "等待成片": "Waiting for final video",
  "全部分段完成后，点击“合并复刻成片”。": "Once all segments finish, click Merge Final Video.",
  "没有可用的 H3 Ref2VA 模型": "No H3 Ref2VA model is available",
  "草稿已保存，尚未提交生成": "Draft saved. Generation has not started.",
  "项目已恢复": "Project restored",
  "分段已保存；受影响的连续片段需要重新生成": "Segment saved. Affected continuation segments need regeneration.",
  "已开始生成未完成分段": "Generating unfinished segments",
  "已请求停止，完成结果会保留": "Stop requested. Completed results will be kept.",
  "正在合并成片": "Merging final video",
  "已提交当前分段": "Segment submitted",
  "H3 每段不超过 15.1 秒，按合法时长分段生成，短视频补足一段后裁回原时长。总时长不设固定上限，上传大小、项目容量与可用存储仍受服务器配置约束。": "H3 generates segments up to 15.1 seconds, padding short inputs and trimming to the source duration. No fixed total duration limit; upload size, project capacity and storage remain subject to server limits.",

  "画布": "Canvas",
  "资产": "Assets",
  "结果": "Results",
  "复刻": "Replicate",
  "复刻工坊": "Replication Workshop",
  "来源视频不限总时长 · H3 分段生成": "No fixed source duration limit · H3 segmented generation",
  "选择来源视频…": "Select a source video…",
  "请先选择来源视频。": "Please select a source video.",
  "来源视频需要有效时长，且至少包含一帧 24 FPS 画面。": "The source needs a valid duration of at least one frame on the 24 FPS timeline.",
  "H3 会按合法时长分段生成，短视频补足一段后裁回原时长。总时长不设固定上限，上传大小、项目容量与可用存储仍受服务器配置约束。": "H3 generates legal segments and trims short videos back to their source duration. There is no fixed duration cap; upload size, project capacity, and available storage still depend on server configuration.",
  "关闭复刻工坊": "Close replication workshop",
  "来源视频": "Source Video",
  "视频资产": "Video Asset",
  "上传本地视频": "Upload Local Video",
  "复刻意图": "Replication Intent",
  "复刻说明": "Replication Brief",
  "需要保留": "Preserve",
  "替换人物": "Replace Subject",
  "替换产品": "Replace Product",
  "替换场景": "Replace Setting",
  "视觉风格": "Visual Style",
  "替换参考": "Replacement References",
  "连续性": "Continuity",
  "分析并生成复刻方案": "Analyze and Build Plan",
  "执行方案": "Execution Plan",
  "创建项目并开始生成": "Create Project and Generate",
  "合并复刻成片": "Merge Final Video",
  "在长视频中精修": "Refine in Long Video",
  "长视频": "Long Video",
  "上传": "Upload",
  "换声": "Voice Conversion",
  ...
  "引导强度": "Guidance Scale",
  "引导强度说明": "Guidance scale help",
  "控制扩散生成对条件信息的引导幅度，不是音量或参考音频占比。官方默认 0.7，通常建议 0.6–0.8。提高可能强化参考音色，也可能带来颤音、金属感或咬字不稳；降低通常更自然，但音色相似度可能下降。不是越高越好。": "Controls how strongly diffusion generation follows its conditioning; it is not volume or a reference-audio mix ratio. The upstream default is 0.7, and 0.6–0.8 is usually recommended. Raising it may strengthen the reference timbre, but can also add tremolo, metallic artifacts, or unstable articulation. Lowering it is often more natural, but may reduce timbre similarity. Higher is not always better.",
  "随机种子": "Random Seed",
  "步": "steps",
  "引导": "Guidance",
  "种子": "Seed",
